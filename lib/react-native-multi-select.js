...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    noItemLabelText: PropTypes.string,
  ...
  static defaultProps = {
    ...
    selectLabelText: 'selected',
    noItemLabelText: 'No item to display.',
    hideSearch: false,
  };
  ...
  _getSelectLabel = () => {
    const { selectText, single, selectedItems, displayKey, selectLabelText } = this.props;
    ...
    return `${selectText} (${selectedItems.length} ${selectLabelText})`;
  };
              ...
              >
                <TouchableWithoutFeedback onPress={this._toggleSelector}>
                  ...
                  >
                    ...
                    <Icon
                      name={hideSubmitButton ? 'chevron-forward-outline' : 'chevron-down-outline'} 
                      style={[
                        styles.indicator,
                        {
                          fontSize: 22
